...
func TestLoadFromYAML(t *testing.T) {
	ignores := cmpopts.IgnoreUnexported(
		turbocache.Workspace{},
		turbocache.Component{},
		turbocache.Package{},
		turbocache.WorkspaceProvenance{},
		turbocache.GitInfo{},
	)
						...
						Packages: []turbocache.Package{
							{
								PackageInternal: turbocache.PackageInternal{
									Name:    "pkg1",
									Type:    turbocache.GenericPackage,
									Sources: []string{"**"},
								},
				...
				Components: []Component{
					{
						...
						Comp: turbocache.Component{
							Constants: turbocache.Arguments{
								"hello": "world",
							},
						},
						Packages: []turbocache.Package{
