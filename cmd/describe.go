...
func getTarget(args []string, findScript bool) (comp *turbocache.Component, pkg *turbocache.Package, script *turbocache.Script, exists bool) {
...
func absPackageName(workspace turbocache.Workspace, name string) string {
...
func newMetadataDescription(pkg *turbocache.Package) packageMetadataDescription {
...
func newPackageDesription(pkg *turbocache.Package) packageDescription {
...
func describePackage(out *prettyprint.Writer, pkg *turbocache.Package) {
...
func newComponentDescription(comp *turbocache.Component) componentDescription {
...
func describeComponent(out *prettyprint.Writer, comp *turbocache.Component) {
	if out.Format == prettyprint.TemplateFormat && out.FormatString == "" {
...
func newScriptDescription(s *turbocache.Script) scriptDescription {
